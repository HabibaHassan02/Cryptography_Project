...
async def hello():
    ...
    async with websockets.connect("ws://localhost:8765") as websocket:
            ...
            v1,v2 = elgamalDecryption(int(y_b_d), int(C1), int(C2),  int(q_g) , a_g)
            ...
            while True:
                ...
                print(iv)
                message_recived = decrypt_aes (data,key,iv)
                print("Message recived from Alice = ", message_recived.decode("utf-8"))
                data  = input()
